...
SECRET_KEY = "django-insecure-0(^^q(q&*y$m82o^aft31=5bi#v(u&%lelrera@tow8z)t4lio"

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [https://stationary-websit-with-django.vercel.app/]
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR / "templates",  # This is the path to the templates folder
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
